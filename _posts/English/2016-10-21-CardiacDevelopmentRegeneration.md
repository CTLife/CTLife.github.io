...
Keywords: heart development, cardiac regeneration, cis-acting element, epigenetics, gene regulatory network.
...
这是我的生理学课程期末论文，太偏分子了，老师说过不能这样，不知道能不能过！

本来想把 ncRNA regulation, Nonlinear and stochastic dynamics model, Machine Learning Model in the heart development, Tissue Engineering and Synthetic Biology in cardiac regeneration, 都加进去，但由于时间不够了，老师也说过五六页就够了，所以就省掉了。                
